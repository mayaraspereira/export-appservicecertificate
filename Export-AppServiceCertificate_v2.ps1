...
$ascResource = Get-AzResource -ResourceId "/subscriptions/$subscriptionId/resourceGroups/$certResourceGroup/providers/Microsoft.CertificateRegistration/certificateOrders/$certName"
...
$pfxPassword = -join ((65..90) + (97..122) + (48..57) | Get-Random -Count 25 | % {[char]$_})
